...
export const realEstateFinanceStub = (): RealEstateInterface => {
  return {
    // "re_id": "Iure non qui excepturi suscipit perferendis aut id.",
    assetPrice: 24,
    closingCost: 33,
    expectedReserveFunds: 4,
    renovationCosts: 42,
    propertyTaxes: 28,
    insurance: 21,
    utilities: 14,
    expectedGrossRentPerProperty: 0,
    totalInvestments: 36,
    listingPrice: 30,
    expenses: 38,
    platformListingFees: 1,
    platformFees: 32,
    propertyMgtFees: 5,
    maintenanceExpense: 34,
    expectedNetRentPerProperty: 41,
    expectedGrossRoi:
      'Accusamus excepturi est. Beatae magnam molestias qui quasi et. Nostrum corrupti autem et beatae aperiam. Voluptatem et autem a animi et sed sint.\n \rUt consequuntur accusamus vitae perferendis consequatur. Libero nihil non. Vel architecto voluptates et animi sunt quibusdam. Id sed dolores. Et autem sunt libero hic atque qui.\n \rAt provident qui dolores reprehenderit. Dolores qui eum labore corrupti eos consequuntur sint dignissimos voluptate. Porro ea ducimus sint dolore.',
    expectedNetRoi: 'Officia a quia perspiciatis fugiat. Aut autem vel qui enim.',
    netRentPerToken: 100,
    totalNumberOfTokens: 14,
    tokenPrice: 100,
    platformListFeesInPercentage: 4,
    rentProcessingFees: 19,
    propertyMgmtFees: 3,
    maintenanceExpenseInPercentage: 9,
  }
}

export const realEstateBasicInfo = (): IRealEstateListing | INoPropertFound => {
  return {
    deeds: [
      {
...
export const realEstateBasicInfoFromUI = (): IRealEstateListing => {
  return {
    deeds: [
      {
        document_type: 'WARRANTY DEED',
